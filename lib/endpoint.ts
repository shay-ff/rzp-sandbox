...
export const endpointGroups: EndpointGroup[] = [
    {
        ...
        endpoints: [
            ...
            {
                id: "fetch_all_orders_with_payment_card",
                label: "Fetch All Orders with Payment Card Details",
                method: "GET",
                url: "https://api.razorpay.com/v1/orders?expand[]=payments.card",
            }
        ],
    },
    {
    ...
    },
    {
        ...
        endpoints: [
            ...
            },
            {
                ...
                label: "Fetch All Payments with Card Details",
                method: "GET",
                url: "https://api.razorpay.com/v1/payments?expand[]=card",
            },
            {
    ...
    },
    {
        ...
        endpoints: [
            ...
            },
            {
                ...
                method: "GET",
                url: "https://api.razorpay.com/v1/payments/qr_codes/:qr_code_id",
                params: ["qr_code_id"],
            },
            {
            ...
            },
            {
                ...
                label: "Close QR Code",
                method: "POST",
                url: "https://api.razorpay.com/v1/payments/qr_codes/:qr_code_id/close",
                params: ["qr_code_id"],
                hideBody: true,
            }
        ],
